					...
					if (basename($_SERVER['PHP_SELF']) == "index.php") { ?>
							...
							<ul class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar" id="layers">
								...
								if (isset($groupResult)) {
									...
									<li name="groups" class="sidebar-item">
										<a class="sidebar-link collapsed" data-bs-toggle="collapse" data-bs-target="#groupSubmenu<?php echo $groupId; ?>" aria-expanded="false"><?php echo $groupName; ?> </a>
												...
												<?php $i = 0;
													foreach ($allLayers as $title => $layersGroup) {
														...
														if (mysqli_num_rows($sqlParent) > 0) {
															...
															$res = $row['name'];
															if ($res == $groupName) { ?>
																<label id="<?php echo $allLayersUrls[$i]; ?>" class="form-check layer-url"><input class="form-check-input layercheckbox" type="checkbox" name="<?php echo $groupName ?>" id="<?php echo $allLayersNames[$i] ?>"><span class="form-check-label"><?php echo $title; ?> </span></label> <?php
						...
						<li class="sidebar-item">
							...
							<ul class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar" id="instructions">
								...
								<li class="sidebar-item">
									<a class="sidebar-link collapsed" data-bs-toggle="collapse" data-bs-target="#history" aria-expanded="false"><img src="img/icons/history.PNG" style="width: 30px; height: 20px; border-radius: 4px;"> Zooming history</a>
								...
								<li class="sidebar-item">
									<a class="sidebar-link collapsed" data-bs-toggle="collapse" data-bs-target="#squarezoom" aria-expanded="false"><img src="img/icons/squarezoom.PNG" style="width: 30px; height: 30px; border-radius: 4px;"> Square zooming</a>
								...
								<li class="sidebar-item">
									<a class="sidebar-link collapsed" data-bs-toggle="collapse" data-bs-target="#ruler" aria-expanded="false"><img src="img/icons/ruler.PNG" style="width: 30px; height: 30px; border-radius: 4px;"> Ruler</a>
									<ul class="sidebar-dropdown list-unstyled collapse" id="ruler">
										<ul><label>Ruler for the distance and bearing measuring. Press ESC or double-click to stop using the ruler, and press ESC again to clean the map</label></ul>
									</ul>
								</li>
								<li class="sidebar-item">
									<a class="sidebar-link collapsed" data-bs-toggle="collapse" data-bs-target="#opacity" aria-expanded="false"><img src="img/icons/opacity.PNG" style="width: 100px; height: 20px; border-radius: 4px;"> Opacity</a>
								...
								<li class="sidebar-item">
									<a class="sidebar-link collapsed" data-bs-toggle="collapse" data-bs-target="#coordinates" aria-expanded="false"><img src="img/icons/coordinates.PNG" style="width: 200px; height: 17px; border-radius: 4px;"></a>
									<ul class="sidebar-dropdown list-unstyled collapse" id="coordinates">
										<ul><label>Hover the mouse on the map to see live longitude and latitude, or click on the icon to put your ones to put a marker on the map</label></ul>
									</ul>
								</li>
								<li class="sidebar-item">
									<a class="sidebar-link collapsed" data-bs-toggle="collapse" data-bs-target="#print" aria-expanded="false"> Print the map</a>
									<ul class="sidebar-dropdown list-unstyled collapse" id="print">
										<ul><label>Use the shortcut CTRL+P to print the map</label></ul>
									</ul>
								</li>
								<li class="sidebar-item">
									<a class="sidebar-link collapsed" data-bs-toggle="collapse" data-bs-target="#sort" aria-expanded="false"> Sort layers</a>
									<ul class="sidebar-dropdown list-unstyled collapse" id="sort">
										<ul><label>Sort the layers or the groups of the layers by pressing, holding and moving them up or down in the list of layers. Layers on top of the list show up on top of other layers on the map</label></ul>
									</ul>
								</li>
								<li class="sidebar-item">
									<a class="sidebar-link collapsed" data-bs-toggle="collapse" data-bs-target="#data" aria-expanded="false"> See data</a>
									<ul class="sidebar-dropdown list-unstyled collapse" id="data">
										<ul><label>Click on any layer on the map to see the popup with all the information about each layer. Be aware that order of the layers does not affect order of the popups</label></ul>
									</ul>
								</li>
							</ul>
						</li>
